...
/* WIDGETS */
				...
				<div class="wq-buscar">
					<?php
						if ($title !== NULL && strlen($title) > 0) {
							?>
								<h3 class="wq-titulo_1"><?php echo $title; ?></h3>
							<?php
						}
					?>
					<form method="get" action="<?php echo home_url(); ?>">
						<input type="text" placeholder="Buscar" name="s">
						<button class="flaticon-search-1" type="submit"></button>
					</form>
				</div>
			<?php
		}
	...
	Class WQ_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
		...
		<div class="wq-ultimos-posts">
			<?php echo $args['before_widget']; ?>
			<h3 class="wq-titulo_1">
				<?php if ( $title ) {
					echo $title;
				} ?>
			</h3>
			<ul>
				...
				?>
					<li>
						...
						<span class="wq-data"><?php echo get_the_date('d', $item->ID); ?> de <?php echo get_the_date('F', $item->ID); ?> de <?php echo get_the_date('Y', $item->ID); ?></span>
					</li>
